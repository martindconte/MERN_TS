...
export const FormBodyCentral = ({ register, errors, requiredFields = true }: FormBodyCentralProps) => {
  return (
    <div className='flex flex-col text-black text-sm'>
      ...
      <div className='flex flex-col-reverse'>
        <div className='flex justify-between my-2 items-center space-x-3'>
          <label className='w-1/3 text-right' htmlFor='codeName'>
            Codigo
          </label>
          <input
            className='w-2/3 border border-gray-300 p-1 outline-none rounded shadow-md'
      ...
      <div className='flex flex-col-reverse'>
        <div className='flex justify-between my-2 items-center space-x-3'>
          <label className='w-1/3 text-right' htmlFor='siteCode'>
            Emplazamiento
          </label>
          <input
            className='w-2/3 border border-gray-300 p-1 outline-none rounded shadow-md'
      ...
      <div className='flex justify-between my-2 items-center space-x-3'>
        <label className='w-1/3 text-right' htmlFor='provinceName'>
          Provincia
        </label>
        <input
          className='w-2/3 border border-gray-300 p-1 outline-none rounded shadow-md'
      ...
      <div className='flex justify-between my-2 items-center space-x-3'>
        <label className='w-1/3 text-right' htmlFor='districtName'>
          Partido
        </label>
        <input
          className='w-2/3 border border-gray-300 p-1 outline-none rounded shadow-md'
      ...
      <div className='flex justify-between my-2 items-center space-x-3'>
        <label className='w-1/3 text-right' htmlFor='localityName'>
          Localidad
        </label>
        <input
          className='w-2/3 border border-gray-300 p-1 outline-none rounded shadow-md'
      ...
      <div className='flex justify-between my-2 items-center space-x-3'>
        <label className='w-1/3 text-right' htmlFor='address'>
          Domicilio
        </label>
        <input
          className='w-2/3 border border-gray-300 p-1 outline-none rounded shadow-md'
      ...
      <div className='flex flex-col-reverse'>
        <div className='flex justify-between my-2 items-center space-x-3'>
          <label className='w-1/3 text-right' htmlFor='latitude'>
            Latitud
          </label>
          <input
            className='w-2/3 border border-gray-300 p-1 outline-none rounded shadow-md'
      ...
      <div className='flex flex-col-reverse'>
        <div className='flex justify-between my-2 items-center space-x-3'>
          <label className='w-1/3 text-right' htmlFor='longitude'>
            Longitud
          </label>
          <input
            className='w-2/3 border border-gray-300 p-1 outline-none rounded shadow-md'
      ...
      <div className='flex flex-col-reverse'>
        <div className='flex justify-between my-2 items-center space-x-3'>
          <label className='w-1/3 text-right' htmlFor='status'>
            Estado
          </label>
          <select
            className='w-2/3 border border-gray-300 p-1 outline-none rounded shadow-md'

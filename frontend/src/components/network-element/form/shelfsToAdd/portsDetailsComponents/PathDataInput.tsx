...
export const PathDataInput = ({ register, control, indexShelf, indexSlot, indexPort, toggleName }: Props) => {
  return (
      ...
      <div className='flex flex-col gap-3 w-full'>
        <div className='flex items-center gap-2 w-full'>
          <div className='flex items-center gap-2'>
            <label htmlFor='IUId' className='text-nowrap'>
              ID IU:
            </label>
            <input
              type='text'
          ...
          <div className='flex items-center gap-2 grow'>
            <label htmlFor='pathName' className='text-nowrap'>
              Path:
            </label>
            <input
              type='text'
          ...
          <div className='flex items-center gap-2'>
            <label htmlFor='datoBasico' className='text-nowrap'>
              DBTX
            </label>
            <input
              type='text'
        ...
        <div className='flex items-center gap-2'>
          <div className='flex items-center gap-2'>
            <label htmlFor='client' className='text-nowrap'>
              Cliente:
            </label>
            <input
              type='text'
          ...
          />
          <div className='flex items-center gap-2 grow'>
            <label htmlFor='observation' className='text-nowrap'>
              Observaciones:
            </label>
            <textarea
              id='observation'

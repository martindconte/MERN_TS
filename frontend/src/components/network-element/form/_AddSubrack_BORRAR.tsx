...
//   subracksAdded: SubrackType[]; // subracks agregados al NE
...
//     const isRegisted = subracksAdded.some( subrack => subrack.id === subrackIdSelected )
...
//         slots: subracksAdded.find( subrack => subrack.id === subrackIdSelected )?.slots?.map( slot => ({
//           number: slot.number,

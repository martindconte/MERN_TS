...
export const Table = <T extends Identifiable>({ data, pagination, info, page, setPage, limit, setLimit }: Props<T>) => {
        ...
        cell: ({ row }) => (
          <div className={tableStyles.actions}>
            <ButtonActions
              ...
              id={ row.original.id }
            />
            {/* <button onClick={() => console.log('Consultar', row.original.id)}><span className={`material-symbols-outlined ${tableStyles.descriptionIcon}`}>description</span></button> */}
            {/* <button onClick={() => console.log('Modificar', row.original.id)}><span className={`material-symbols-outlined ${tableStyles.editIcon}`}>edit</span></button> */}
            {/* <button onClick={() => console.log('Eliminar', row.original.id)}><span className={`material-symbols-outlined ${tableStyles.deleteIcon}`}>delete</span></button> */}
          </div>
        ),
      }),

...
export const FormBodySignal = ({ register, errors, requiredFields = true, showBandwidth, setShowBandwidth }: Props) => {
  ...
  return (
    <div className='flex flex-col text-black text-sm'>
      ...
      <div className='flex flex-col-reverse'>
        <div className='flex justify-between my-2 items-center space-x-3'>
          <label className='w-1/3' htmlFor='subType'>
            Sub-Tipo
          </label>
          <input
            className='w-2/3 border border-gray-300 p-1 outline-none rounded shadow-md'
      ...
      <div className='flex justify-between my-2 items-center space-x-3'>
        <label className='w-1/3' htmlFor='observation'>
          Observaciones
        </label>
        <input
          className='w-2/3 border border-gray-300 p-1 outline-none rounded shadow-md'
      ...
      <div className='flex justify-between my-2 items-center space-x-3'>
        <label className='w-1/3' htmlFor='showBandwidth'>
          Agregar Velocidad
        </label>
        <input type='checkbox' id='showBandwidth' onChange={handleCheckboxChange} />
      </div>
      {showBandwidth && (

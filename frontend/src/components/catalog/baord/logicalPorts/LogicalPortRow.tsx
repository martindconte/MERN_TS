  ...
  return (
    <tr>
      <td className='px-2 py-1 border border-gray-400'>
        <select className='outline-none px-2 py-1' value={signal} onChange={event => handleInputChange(id, 'signal', event.target.value)}>
      ...
      <td className='border border-gray-400'>
        <button className='material-symbols-outlined px-2 py-1 text-sm bg-emerald-400 rounded-full mx-1 my-1 cursor-pointer hover:bg-emerald-700 hover:text-white'>
          content_copy
        </button>
        <button

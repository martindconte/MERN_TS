                        ...
                        <ul className='flex flex-col space-y-1'>
                          {port[key].map(equipment => (
                            <Link
                              ...
                              className={`flex items-center justify-between gap-1 px-1 py-1 rounded-md cursor-pointer ${
                                equipment.partNumber.includes('_DELETED_') ? 'bg-red-400' : 'bg-emerald-300'

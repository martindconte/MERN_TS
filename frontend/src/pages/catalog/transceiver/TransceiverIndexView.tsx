    ...
    return (
        <main className='flex-1 px-2 py-4 bg-blue-50'>
            ...
            <div className='flex flex-wrap text-center gap-5 justify-center text-black font-roboto'>
                <Link to='search' className='flex flex-col justify-center py-2 px-3 rounded-md bg-sky-300 w-1/5 hover:bg-sky-500 hover:shadow-2xl hover:shadow-sky-950'>
                ...
                <Link to='new' className='flex flex-col justify-center py-2 px-3 rounded-md bg-violet-300 w-1/5 hover:bg-violet-500 hover:shadow-2xl hover:shadow-violet-950'>
                ...
                <Link to='deleted' className='flex flex-col justify-center py-2 px-3 rounded-md bg-red-400 w-1/5 hover:bg-red-800 hover:text-white hover:shadow-2xl hover:shadow-red-950 group'>
                    ...
                    <p className='text-sm'><span className='uppercase font-bold'>Restaure o ELimine</span> DEFINITIVAMENTE un Transceiver</p>
                </Link>
            </div>
        </main>
    )

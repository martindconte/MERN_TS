      ...
      <div className='flex align-top'>
        ...
        <div className='h-fit flex gap-4'>
          <Link
            ...
            className='bg-blue-600 text-center px-2 py-1 w-48 rounded-lg font-roboto_condensed font-bold uppercase hover:bg-blue-800 hover:text-white'
          >
            Editar
          </Link>
        </div>
